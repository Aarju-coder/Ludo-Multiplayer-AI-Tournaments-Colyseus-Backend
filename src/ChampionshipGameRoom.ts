...
import { ChampionshipSingletonClass } from "./GamePlay/ChampionshipHandler";
const CONSTANTS = {
...
//let playersInGame = {};
export class ChampionshipGameRoom extends Room<State> {
  ...
  tournamentHandler: ChampionshipSingletonClass;
  round: number;
  t_id: string;
  g: any;
  ...
  onCreate(options: any) {
    ...
    this.tournamentHandler = ChampionshipSingletonClass.getInstance();
        ...
        if (!this.gameOverIndex) {
          if (this.playerCount > 1) {
            ...
            if(this.gameStarted){
              ...
              this.broadcast("allPlayerLeft", { gameStarted: this.gameStarted });
            }
